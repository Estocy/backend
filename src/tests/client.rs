...
fn create() {
    ...
    let (response_client, response_client_expected) = create_client();
    ...
    client.delete(format!("/clients/{}",response_client.id))
...
fn show() {
    ...
    let (response_client_create, response_client_expected) = create_client();
...
fn delete() {
    ...
    let response = client.delete(format!("/clients/{}",response_client.id))
        .header(ContentType::JSON)
        .dispatch();
...
fn create_client() -> (Client, Client){
    ...
    return (response_client, response_client_expected);
}