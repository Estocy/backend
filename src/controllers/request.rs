...
use crate::models::request::{Request, RequestReceiver};
use crate::models::request_product::RequestProduct;
use diesel::prelude::*;
...
pub fn create(request: Json<RequestReceiver>) -> Json<Request> {
    ...
    let _request_produt: RequestProduct = diesel::insert_into(requests_products)
        .values((
...
pub fn delete(id: String) -> Option<()> {
    ...
    let result = diesel::delete(request).execute(&connection);
